    ...
    <section className="py-20 bg-gray-50 dark:bg-gray-900/40 transition-colors duration-300">
      <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          onClick={next}
          className="mt-8 inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium hover:bg-white dark:hover:bg-gray-900 transition-colors duration-300"
        >
