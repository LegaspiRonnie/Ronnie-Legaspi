        ...
        {project.tags && (
          <div className="flex flex-wrap gap-1.5 pt-2">
            {project.tags.map((tag) => {
              ...
              return (
                <span key={tag} className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium bg-blue-50 dark:bg-gray-950/30 text-blue-700 dark:text-blue-400">
