    ...
    <>
      <div className="fixed bottom-6 left-6 z-40">
        <motion.button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-white dark:bg-blue-900 border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium shadow-lg hover:shadow-xl"
        >
