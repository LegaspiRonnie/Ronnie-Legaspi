    ...
    <section id="pricing" className="py-20 bg-gray-50 dark:bg-gray-900/40 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <div
            data-reveal="true"
            className="relative bg-white dark:bg-gray-900 rounded-lg p-6 flex flex-col transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-gray-200/60 dark:hover:shadow-none border border-gray-200 dark:border-gray-800 hover:border-blue-200 dark:hover:border-blue-900 in-view"
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 hover:scale-[1.03] active:scale-[0.98] border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-900"
            >
          ...
          <div
            data-reveal="true"
            className="relative bg-white dark:bg-gray-900 rounded-lg p-6 flex flex-col transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-gray-200/60 dark:hover:shadow-none border-2 border-blue-600 ring-1 ring-blue-600/20 md:-translate-y-2 in-view"
