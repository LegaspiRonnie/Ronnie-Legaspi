...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-white dark:bg-blue-950 transition-colors duration-300 min-h-svh flex items-center"
    >
           ...
           <Stagger stagger={0.12} delayChildren={0.05}>
            ...
            <StaggerItem effect="up" duration={0.6} className="flex flex-wrap items-center gap-3">
              ...
              <MagneticButton href="#contact" strength={0.3}>
                <span className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium transition-all duration-300 hover:scale-[1.04] hover:bg-white dark:hover:bg-blue-950 hover:border-gray-300 dark:hover:border-gray-700">
                  Get in touch
                </span>
              </MagneticButton>
            </StaggerItem>
