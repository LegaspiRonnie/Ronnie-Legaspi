        ...
        <Stagger stagger={0.12} className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl">
          <StaggerItem>
            <motion.div
              ...
              className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex items-center gap-4 transition-all duration-500 hover:shadow-lg hover:shadow-gray-200/60 dark:hover:shadow-none hover:border-blue-200 dark:hover:border-blue-900"
            >
              <img
