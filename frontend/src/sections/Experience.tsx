    ...
    <StaggerItem effect="left" className={`relative ${isLast ? '' : 'pb-8'}`}>
      <div
        className={`absolute -left-6 top-1 w-3.5 h-3.5 rounded-full ${
          filledDot ? 'bg-blue-700 border-2 border-white dark:border-gray-950' : 'border-2 border-gray-300 dark:border-gray-700 bg-white dark:bg-blue-900'
        }`}
      ></div>
...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-20 bg-white dark:bg-blue-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <Stagger stagger={0.15} className="relative pl-6">
            <div className="absolute left-[7px] top-1 bottom-1 w-px bg-gray-200 dark:bg-blue-900"></div>
