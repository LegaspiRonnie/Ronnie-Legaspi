...
export default function ExperienceSnapshot() {
  ...
  return (
    <section className="py-20 bg-blue-100 dark:bg-gray-950/40 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <Reveal effect="left" className="grid grid-cols-1 lg:grid-cols-[1fr_auto] items-center gap-8">
          <motion.div
            whileHover={{ y: -4 }}
            transition={{ type: 'spring', stiffness: 300, damping: 24 }}
            className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 sm:p-8 transition-all duration-500 hover:shadow-lg hover:shadow-gray-200/60 dark:hover:shadow-none hover:border-blue-200 dark:hover:border-blue-900"
          >
          ...
          <Link
            to="/about"
            className="shrink-0 inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium transition-all duration-300 hover:scale-[1.03] hover:bg-white dark:hover:bg-gray-950 hover:border-gray-300 dark:hover:border-gray-700 whitespace-nowrap"
          >
            See full experience
