...
export default function Projects() {
  ...
  const viewButton = (name: View, path: string) => (
    <button
      ...
      className={`p-1.5 rounded-md transition-colors duration-300 ${
        view === name
          ? 'bg-white dark:bg-blue-950 text-blue-700 dark:text-blue-400 shadow-sm'
  ...
  return (
    <>
      <section className="py-16 bg-white dark:bg-blue-950 transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <Reveal effect="fade" className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <div className="inline-flex items-center gap-1 p-1 rounded-lg bg-white dark:bg-blue-950 self-start">
              ...
              return (
                <StaggerItem key={project.id} effect="blur">
                  <motion.div
                    ...
                    className={`group bg-white dark:bg-blue-950 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-lg hover:shadow-gray-200/60 dark:hover:shadow-none hover:border-blue-200 dark:hover:border-blue-900 ${
