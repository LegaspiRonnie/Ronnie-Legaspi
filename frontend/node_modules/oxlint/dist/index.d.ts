 ...
 */
type CurlyType = "all" | "multi" | "multi-line" | "multi-or-nest";
/**
 ...
 */
type AllowKind = "functions" | "arrowFunctions" | "generatorFunctions" | "methods" | "generatorMethods" | "getters" | "setters" | "constructors" | "asyncFunctions" | "asyncMethods" | "privateConstructors" | "protectedConstructors" | "decoratedFunctions" | "overrideMethods";
/**
 ...
 */
type ForbidItem = string | ForbidItemObject;
/**
 * A forbidden prop, either as a plain prop name string or with options.
 */
type ForbidDomPropsItem = string | PropWithOptions;
/**
 * A forbidden element, either as a plain element name or with a custom message.
 */
type ForbidItem2 = string | {
  /**
...
interface ClassMethodsUseThisConfig {
  /**
...
interface GroupedAccessorPairsConfig {
  /**
...
interface NewlineAfterImport {
  considerComments?: boolean;
  count?: number;
  exactCount?: boolean;
}
interface NoAbsolutePath {
  /**
...
interface NoAnonymousDefaultExport {
  /**
...
interface NoNodejsModulesConfig {
  /**
   * Array of names of allowed modules. Defaults to an empty array.
   */
  allow: string[];
}
interface NoUnassignedImportConfig {
  /**
...
interface ConsistentTestItConfig {
  /**
...
interface EmptyTagsConfig {
  /**
   * Additional tags to check for their descriptions.
   */
  tags?: string[];
}
interface NoDefaultsConfig {
  /**
...
interface AutocompleteValidConfig {
  /**
...
interface LogicalAssignmentOperatorsConfig {
  /**
...
interface MaxClassesPerFileConfig {
  /**
...
interface MaxLinesPerFunctionConfig {
  /**
...
interface NoEmptyFunctionConfig {
  /**
...
interface NoGlobalAssignConfig {
  /**
...
interface NoImplicitCoercionConfig {
  /**
...
interface NoImplicitGlobalsConfig {
  lexicalBindings?: boolean;
}
interface NoInlineCommentsConfig {
  /**
...
interface NoIrregularWhitespaceConfig {
  /**
...
interface NoMagicNumbersConfig {
  /**
...
interface NoMisleadingCharacterClass {
  /**
...
interface NoParamReassignConfig {
  /**
...
interface RestrictDefaultExports {
  /**
...
interface NoShadowRestrictedNamesConfig {
  /**
...
interface NoUnderscoreDangleConfig {
  /**
...
interface NoUnsafeOptionalChaining {
  /**
...
interface NoUnusedExpressionsConfig {
  /**
 ...
 */
interface NoUnusedVarsFixOptions {
  /**
...
interface NoUselessEscapeConfig {
  /**
...
interface NoUselessRenameConfig {
  /**
...
interface NoWarningCommentsConfigJson {
  decoration?: string[];
  location?: Location;
  terms?: string[];
}
...
interface NoOptionalChainingConfig {
  /**
...
interface NoRestSpreadPropertiesOptions {
  /**
...
interface PreferRegexLiteralsConfig {
  /**
...
interface CheckedRequiresOnchangeOrReadonly {
  /**
...
interface ForbidElementsConfig {
  /**
...
interface JsxBooleanValueOptions {
  /**
...
interface PreferFunctionComponent {
  /**
...
interface ExplicitFunctionReturnTypeConfig {
  /**
...
interface ExplicitMemberAccessibilityConfig {
  /**
...
interface ExplicitModuleBoundaryTypesConfig {
  /**
...
interface NoBaseToStringConfig {
  /**
...
interface NoConfusingVoidExpressionConfig {
  /**
...
interface NoFloatingPromisesConfig {
  /**
...
interface NoRequireImportsConfig {
  /**
...
interface NoUnnecessaryBooleanLiteralCompareConfig {
  /**
...
interface NoUnsafeMemberAccessConfig {
  /**
...
interface OnlyThrowErrorConfig {
  /**
...
interface PreferPromiseRejectErrorsConfig {
  /**
...
interface RequireArraySortCompareConfig {
  /**
   * Whether to ignore arrays in which all elements are strings.
   */
  ignoreStringArrays?: boolean;
}
interface RestrictPlusOperandsConfig {
  /**
...
interface RestrictTemplateExpressionsConfig {
  /**
...
interface StrictBooleanExpressionsConfig {
  /**
...
interface StrictVoidReturnConfig {
  /**
   * Allow callbacks that return `any` in places that expect a `void` callback.
   */
  allowReturnAny?: boolean;
}
interface SwitchExhaustivenessCheckConfig {
  /**
...
interface UnifiedSignaturesOptions {
  /**
...
interface TextEncodingIdentifierCase {
  /**
...
interface NoReservedKeysConfig {
  /**
...
interface NoReservedPropsConfig {
  /**
...
interface ReturnInComputedPropertyConfig {
  /**
