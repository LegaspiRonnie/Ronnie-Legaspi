        ...
        <Stagger stagger={0.15} className="flex flex-col gap-6">
          {samples.map((sample) => (
            <StaggerItem key={sample.slug} effect="right">
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 transition-all duration-500 hover:shadow-lg hover:shadow-gray-200/60 dark:hover:shadow-none hover:border-blue-200 dark:hover:border-blue-900">
