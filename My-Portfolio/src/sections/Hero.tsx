...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-white dark:bg-gray-950 transition-colors duration-300 min-h-screen"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 min-h-screen py-24 lg:py-0 flex items-center">
        <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-center gap-14 lg:gap-16">
